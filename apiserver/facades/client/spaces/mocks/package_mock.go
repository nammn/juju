...
// ParseLocalIDToTags mocks base method
func (m *MockBacking) ParseLocalIDToTags(arg0 string) names_v3.Tag {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "ParseLocalIDToTags", arg0)
	ret0, _ := ret[0].(names_v3.Tag)
	return ret0
}

// ParseLocalIDToTags indicates an expected call of ParseLocalIDToTags
func (mr *MockBackingMockRecorder) ParseLocalIDToTags(arg0 interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "ParseLocalIDToTags", reflect.TypeOf((*MockBacking)(nil).ParseLocalIDToTags), arg0)
}
